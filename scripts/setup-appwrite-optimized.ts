...
async function setup() {
  try {
    ...
    // Collection 1: test_results (optimisée)
    ...
    await databases.createStringAttribute(db.$id, resultsId, "session_id", 100, true);
    await new Promise(r => setTimeout(r, 500));
    await databases.createStringAttribute(db.$id, resultsId, "email", 150, false);
    await new Promise(r => setTimeout(r, 500));
    await databases.createIntegerAttribute(db.$id, resultsId, "score", true);
    await new Promise(r => setTimeout(r, 500));
    await databases.createStringAttribute(db.$id, resultsId, "badge", 100, true);
    await new Promise(r => setTimeout(r, 500));
    await databases.createStringAttribute(db.$id, resultsId, "badge_color", 20, true);
    await new Promise(r => setTimeout(r, 500));
    await databases.createStringAttribute(db.$id, resultsId, "data", 50000, true);
    await new Promise(r => setTimeout(r, 500));
    await databases.createIntegerAttribute(db.$id, resultsId, "social_score", false);
    await new Promise(r => setTimeout(r, 500));
    await databases.createBooleanAttribute(db.$id, resultsId, "premium", false, false);
    ...
    await new Promise(r => setTimeout(r, 1000));
    await databases.createStringAttribute(db.$id, referralsId, "inviter_id", 100, true);
    await new Promise(r => setTimeout(r, 500));
    await databases.createStringAttribute(db.$id, referralsId, "invitee_email", 150, true);
    await new Promise(r => setTimeout(r, 500));
    await databases.createStringAttribute(db.$id, referralsId, "result_id", 100, false);
    await new Promise(r => setTimeout(r, 500));
    ...
    await new Promise(r => setTimeout(r, 1000));
    await databases.createStringAttribute(db.$id, validationsId, "result_id", 100, true);
    await new Promise(r => setTimeout(r, 500));
    await databases.createStringAttribute(db.$id, validationsId, "validator_session", 100, true);
    await new Promise(r => setTimeout(r, 500));
    await databases.createStringAttribute(db.$id, validationsId, "answers", 5000, true);
    ...
    await new Promise(r => setTimeout(r, 1000));
    await databases.createStringAttribute(db.$id, paymentsId, "email", 150, false);
    await new Promise(r => setTimeout(r, 500));
    await databases.createStringAttribute(db.$id, paymentsId, "transaction_id", 100, true);
    await new Promise(r => setTimeout(r, 500));
    ...
    await new Promise(r => setTimeout(r, 500));
    await databases.createStringAttribute(db.$id, paymentsId, "provider", 30, true);
    await new Promise(r => setTimeout(r, 500));
    await databases.createStringAttribute(db.$id, paymentsId, "meta", 5000, false);
...
setup()
  .then(async (ids) => {
    ...
    try {
      execSync(`echo "${ids.resultsId}" | npx vercel env rm APPWRITE_COLLECTION_RESULTS production`, { stdio: "inherit" });
    } catch {}
    execSync(`echo "${ids.resultsId}" | npx vercel env add APPWRITE_COLLECTION_RESULTS production`, { stdio: "inherit" });
    
    try {
      execSync(`echo "${ids.referralsId}" | npx vercel env rm APPWRITE_COLLECTION_REFERRALS production`, { stdio: "inherit" });
    } catch {}
    execSync(`echo "${ids.referralsId}" | npx vercel env add APPWRITE_COLLECTION_REFERRALS production`, { stdio: "inherit" });
    
    try {
      execSync(`echo "${ids.validationsId}" | npx vercel env rm APPWRITE_COLLECTION_VALIDATIONS production`, { stdio: "inherit" });
    } catch {}
    execSync(`echo "${ids.validationsId}" | npx vercel env add APPWRITE_COLLECTION_VALIDATIONS production`, { stdio: "inherit" });
    
    try {
      execSync(`echo "${ids.paymentsId}" | npx vercel env rm APPWRITE_COLLECTION_PAYMENTS production`, { stdio: "inherit" });
    } catch {}
